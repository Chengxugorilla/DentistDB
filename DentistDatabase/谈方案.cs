...
namespace DentistDatabase
{
    public partial class 谈方案 : Form
    {
        ...
        {
            String sqlText = "SELECT 谈方案.就诊记录, 谈方案.谈方案次数,谈方案.是否谈方案, 谈方案.是否签手术同意书, 谈方案.种植态度, 谈方案.是否种植模拟 " +
